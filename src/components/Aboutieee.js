    ...
    <div className='bg-sky-700 px-6 pb-8'>
          ...
          <div className='sm:flex mt-8'>
            <div className='bg-sky-900 m-3'>
             ...
             <button className=' py-0.5 px-4 bg-orange-400 hover:bg-red-500 text-slate-100 text-xl font-medium rounded-2xl ml-4 mb-4 cursor-pointer'>Join us</button>
             </a>
            </div>
            <div className='bg-sky-900 sm:ml-6 m-3'>
              <div className='text-3xl font-semibold text-slate-50 p-4 '>IEEE Societies</div>
              <p className='text-lg font-normal text-slate-50 px-4 pb-4 text-justify'>
