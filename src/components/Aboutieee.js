      ...
      <div className='sm:flex mt-8'>
        <div className='bg-sky-900 m-3' style={{ borderRadius: '2%' }}>
          ...
          <a href='https://www.ieee.org/membership/join/index.html?utm_source=button_text&utm_medium=lp-membership&utm_campaign=join'>
            <button
              className=' py-0.5 px-4 bg-[#E87722] hover:bg-red-500 text-slate-100 text-xl font-medium rounded-2xl ml-4 mb-4 cursor-pointer'
              style={{ marginLeft: '65%' }}
            >
              Join us
            </button>
        ...
        <div className='bg-sky-900 sm:ml-6 m-3' style={{ borderRadius: '2%' }}>
          <div className='text-3xl font-semibold text-slate-50 p-4 '>
            IEEE Societies
          </div>
          <p className='text-lg font-normal text-slate-50 px-4 pb-4 text-justify'>
