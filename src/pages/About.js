        ...
        <div className="carousel-and-content">
            ...
            <Container fluid>
                <Row xs={1} md={2} lg={2}>
                    ...
                    <Col style={{ marginBottom: 10, borderRadius: "10%" }}>
                        <iframe style={{ maxHeight: "500px", maxWidth: "1000px", height: "100%", width: "100%" }} src="https://www.youtube.com/embed/ERHPw_OaVI4?si=ZHcyIIQ2xNjotHC8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
